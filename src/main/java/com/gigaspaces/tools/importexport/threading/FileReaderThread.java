	...
	public ThreadAudit call() throws Exception {
		...
		try {
			...
			try {
				...
				} else if (readObject instanceof com.gigaspacesC.tools.importexport.lang.SpaceClassDefinition) {
					com.gigaspacesC.tools.importexport.lang.SpaceClassDefinition classDefinition = (com.gigaspacesC.tools.importexport.lang.SpaceClassDefinition) readObject;

					com.gigaspacesC.tools.importexport.lang.VersionSafeDescriptor typeDescriptor = classDefinition.getTypeDescriptor();
